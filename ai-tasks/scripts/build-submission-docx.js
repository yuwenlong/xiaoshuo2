...
const intro = [
  ...
  '他下楼买了个黑皮笔记本，写下头一行：7月18日，词峰会崩。',
  '明天他去报到。这一行字准不准，下午三点见分晓。',
];
...
const volumes = [
  ['卷一《重回2011》（2011–2012）',
    '陈序在出租屋里醒来。头一天他还是个三十七岁的失业程序员，抱着纸箱走进雨里，喝到断片。醒来摸到的手机比他那部小了一圈，屏幕底下凸出来三颗键。\n隔天他去金杉软件报到。午后他去找副总监要活干，想接那摊没人管的在线版代码，被一句“真出了事，也轮不到一个刚报到的人往上顶”顶了回来。下午三点，公司主力产品词峰在线版全线白屏。日志指到入口文件第87行，全组四十多人往下追了三层就断了。那套PHP代码是刚离职的人留的，没一行注释；回滚也试过，没用。他站出来接了这活，通宵抄完四十多页英文手册，天亮前把系统救了回来。十五年前这一夜他也熬过，功劳记在了别人头上。这一次他留了记录。\n副总监庞坚抢功成性，处处压他。他不争，只把事做实、留痕。大学四年攒下的两千九百块，他全换了比特币，三十二个，没人看得懂他在干什么。买完就开始跌，一路跌到年底，他反倒又凑钱补了两回。\n年底事业部裁撤，庞坚把他的名字报了上去，和前世一模一样。这一次，名单当众翻了盘。\n2011年底，他手里的比特币凑到了将近三百个，总成本八千块。2012年8月，微信公众号上线当天他注册了头一个号；年末他从金杉离职。'],
  ['卷二《风口》（2013–2014）',
...
const persons = [
  ['陈序（男主）', '三十七岁上被AI裁掉，重回2011年报到前夜。技术过硬，谋定后动，认准了就敢下重注。随身一个黑皮笔记本，记着往后十五年的风口和账目。他手里攥着的只是记忆，而记忆会折旧、会记岔，越往后越不好使。'],
...
console.log('         BTC首仓32个@¥90=¥2880、成交后兜里34.5卡里20、2011年末约296个成本¥8000）');
